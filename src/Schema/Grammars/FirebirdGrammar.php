...
namespace Ejetar\LaravelFirebird\Schema\Grammars;

use Ejetar\LaravelFirebird\Schema\SequenceBlueprint;
...
class FirebirdGrammar extends Grammar
{
     ...
     *
     * @param \Ejetar\LaravelFirebird\Schema\SequenceBlueprint $blueprint
     * @param \Illuminate\Support\Fluent $command
     * @return string
     */
